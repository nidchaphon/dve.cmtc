...
mysql_query("UPDATE member SET member_loginstatus = '0',member_lastupdate = NOW()  WHERE 1 AND DATE_ADD(member_lastupdate, INTERVAL $intRejectTime MINUTE) <= NOW()") or die(mysql_error());
